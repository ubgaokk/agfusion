...
data_root = '/media/kanke/easystore/Lambda/Data_set/data_nuscences/nuscenes/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'nuscenes_infos_temporal_train_with_ego_pose.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file=data_root + 'nuscenes_infos_temporal_val_with_ego_pose.pkl',
